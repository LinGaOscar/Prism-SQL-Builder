  ...
  template: `
    <div class="flex flex-col gap-2">
      ...
      <div ref="svgContainer"
           class="bg-[#FAFAF7] dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-4 min-h-48 overflow-auto flex items-start justify-center">
        <p class="text-zinc-400 dark:text-zinc-600 text-sm self-center">尚未解析 DDL</p>
      </div>
    </div>
  `
}
